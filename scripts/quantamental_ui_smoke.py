...
def main() -> int:
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            page.locator("#quantamentalScoreMetric").select_option("momentum", timeout=10_000)
            ...
            page.wait_for_function(
                """() => {
                    ...
                    return (text.includes("Momentum") || text.includes("모멘텀")) && text.includes(">=") && rows > 0 && rows <= 10;
                }""",
                timeout=180_000,
            )
