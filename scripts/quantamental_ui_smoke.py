...
def main() -> int:
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            page.locator("#quantamentalScoreMetric").select_option("trend_efficiency", timeout=10_000)
            ...
            page.wait_for_function(
                """() => {
                    ...
                    return (text.includes("Trend Efficiency") || text.includes("추세 효율")) && text.includes(">=") && rows > 0 && rows <= 10;
                }""",
                timeout=180_000,
            )
