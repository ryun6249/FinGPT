...
REQUIRED_UI_MARKERS: dict[str, str] = {
    ...
    "backtest risk adjusted momentum option": '<option value="risk_adjusted_momentum">위험조정 모멘텀</option>',
...
REQUIRED_APP_JS_MARKERS: dict[str, str] = {
    ...
    "quant risk adjusted momentum label": 'risk_adjusted_momentum: "위험조정 모멘텀"',
