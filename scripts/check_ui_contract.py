...
REQUIRED_UI_MARKERS: dict[str, str] = {
    ...
    "market internal snapshot details tier": '<section class="home-card home-market-panel market-surface" data-panel-tier="details">',
    ...
    "ml forecast signal primary tier": '<section class="home-card forecast-card forecast-surface forecast-signal-card" data-panel-tier="primary">',
    "ml forecast signal": 'id="forecastSignalSurface"',
    "ml forecast signal quality": 'id="forecastSignalQualitySurface"',
    "ml forecast visualization primary tier": '<section class="home-card forecast-card forecast-viz-card forecast-surface" data-panel-tier="primary">',
