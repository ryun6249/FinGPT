...
class UiRoutingContractTests(unittest.TestCase):
    ...
    def test_ai_portfolio_ui_module_contract(self):
        ...
        self.assertIn('src="modules/quantamental-ui.js?v=20260519-quantamental-v16"', html)
        self.assertIn('href="styles.css?v=20260519-continuous-enhancement-v3"', html)
        self.assertIn('src="app.js?v=20260519-continuous-enhancement-v6"', html)
    ...
    def test_cross_dashboard_smoke_tracks_current_bundle_and_quantamental(self):
        ...
        self.assertIn('QUANTAMENTAL_BUNDLE_VERSION = "20260519-quantamental-v16"', smoke_source)
        self.assertIn('APP_BUNDLE_VERSION = "20260519-continuous-enhancement-v6"', smoke_source)
    ...
    def test_quantamental_static_ui_contract(self):
        ...
        for marker in [
            ...
            'src="modules/quantamental-ui.js?v=20260519-quantamental-v16"',
        ]:
            self.assertIn(marker, html)
        for marker in [
