...
class UiRoutingContractTests(unittest.TestCase):
    ...
    def test_ai_portfolio_ui_module_contract(self):
        ...
        self.assertIn('href="styles.css?v=20260523-python-strategy-v4"', html)
        self.assertIn('src="app.js?v=20260523-python-strategy-v4"', html)
    ...
    def test_cross_dashboard_smoke_tracks_current_bundle_and_quantamental(self):
        ...
        self.assertIn('APP_BUNDLE_VERSION = "20260523-python-strategy-v4"', smoke_source)
